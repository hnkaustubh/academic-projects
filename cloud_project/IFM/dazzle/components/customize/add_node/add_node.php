<html>
  <head>
    <title>Node addition form</title>
  ...
  <body>
	...
	<div class="container">
	  <div class="main">
		...
		<form id="form_id" method="post" name="myform" action="simulator.php">
		  <label>Node ID :</label></br>
		  <input type="text" name="node_id" id="username"/></br>
 
		  <label>Under which Cluster ? :</label></br>
		  <input type="text" name="cluster" id="cluster"/></br>
          
          <label>Zone :</label></br>
          <input type="text" name="zone" id="city"/></br>
          
          <label>Street :</label></br>
          <input type="text" name="street" id="street"/></br>
          
 
		  <input type="submit" value="ADD NODE" id="submit" name="submit"/>
