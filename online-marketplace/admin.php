...
<body style="color: white;/*background-color: #FFA07A;*/ font-size: 25px; font-family: sans-serif; background-image: url('img/try5.jpg');">

	<div class="first" style="margin-top: -2px; position: relative; left: 115px; width: 1500px;">
		<ul>
...
<!-- 				<ul></ul> -->
			...
			<li style="font-size: 20px; width: 150px; height: 30px;"><a>Admin</a></li>
	...
	<div class="smartlamps" style="background-image: url('img/wheat.jpg'); height: 180px; margin-top: -52px">
