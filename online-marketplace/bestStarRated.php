...
<!--                <ul></ul> -->
	...
	<div style="margin-left: 50px; color: black; margin-top: -50px;">
		...
		$query1 = "SELECT AVG(rating) as rating FROM publicwifi;";
		...
		$query2 = "SELECT AVG(rating) as rating FROM smartcommunication;";
		...
		$query3 = "SELECT AVG(rating) as rating FROM smartgas;";
		...
		$query4 = "SELECT AVG(rating) as rating FROM smartlamps;";
		...
		$query5 = "SELECT AVG(rating) as rating FROM smartmeter;";
		...
		$query6 = "SELECT AVG(rating) as rating FROM smartparking;";
		...
		$query7 = "SELECT AVG(rating) as rating FROM smartsecurity;";
		...
		$query8 = "SELECT AVG(rating) as rating FROM smarttransportation;";
		...
		$query9 = "SELECT AVG(rating) as rating FROM smarttrash;";
		...
		$query10 = "SELECT AVG(rating) as rating FROM smartwater;";
	...
	<script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Best Star Rated Products'
        };
