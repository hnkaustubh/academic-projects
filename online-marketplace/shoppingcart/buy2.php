...
<body style="padding-left: 80px; font: sans-serif; font-family: Montserrat">
	<div>
		<form action="buy3.php" method="POST">
			...
			<input type="text" name="address1" placeholder="Street Address, P.O.Box, Company Name, c/o" style="border-radius: 4px; width: 550px;height: 25px; position: relative; top: -15px; font-size: 13px;">
			<br>
			<p><strong>Address Line 2</strong></p>
			<input type="text" name="address2" placeholder="Street Address, P.O.Box, Company Name, c/o" style="border-radius: 4px; width: 550px;height: 25px; position: relative; top: -15px; font-size: 13px;">
			<br>
	...
	<div style="width: 500px; height: 500px; margin-left: 700px; margin-top: -1150px; font-weight: bold;">
