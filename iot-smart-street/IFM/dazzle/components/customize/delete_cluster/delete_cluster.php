<html>
  ...
  <body>
	...
	<div class="container">
	  <div class="main">
		<h2>Cluster Deletion</h2><hr/>
 
		<form id="form_id" method="post" name="myform">
		  <label>Cluster ID :</label></br>
		  <input type="text" name="username" id="username"/></br>
 
		  <label>Zone :</label></br>
		  <input type="password" name="password" id="password"/></br>
 
		  <input type="button" value="DELETE CLUSTER" id="submit" onclick="validate()"/><br><br>
          <label>Note: All the underlying nodes will be deleted</label></br>
		</form>
