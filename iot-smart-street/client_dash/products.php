<?php
		...
		if(isset($_POST['smartlights'])){
			...
			header('Location: smartlamps.html');
		}
		else if (isset($_POST['smartwater'])) {
			...
			header('Location: smartwater.html');
		}	
		else if (isset($_POST['smartgas'])) {
			...
			header('Location: smartmeter.html');
		}
		else if (isset($_POST['smartparking'])) {
			...
			header('Location: smartparking.html');
		}
			...
			header('Location: smarttrash.html');
		}
			...
			header('Location: publicwifi.html');
		}
			...
			header('Location: smarttransportation.html');
		}
			...
			header('Location: smartsecurity.html');
		}
			...
			header('Location: smartcomm.html');
		}
	}
...
<body style="background-color: #FFA07A">
	...
	<div style="float: left;width: 400px;height: 350px;">
		<img src="smartLamps.jpg" width="150" height="150" style="margin-left: 100px; margin-top: 130px;">
	</div>
	<form method="POST">
...
<button name="smartlights" onclick="gotoLamps()" style="margin-left: 400px; width: 150px;height: 30px;color: green;background: black; font-size: 20px;"><strong>Check out!</strong></button>
	</div>
	<div style="float: left;width: 400px;height: 350px;">
		<img src="smartWater.jpg" width="150" height="150" style="margin-top: 150px; margin-left: 100px">
	</div>
	<div  style="width: 70%;float: right; color: black;">
		<h3>Smart Water</h3>
		<p>
...
<button name="smartwater" style="margin-left: 400px; width: 150px;height: 30px;color: green;background: black; font-size: 20px;"><strong>Check out!</strong></button>
	</div>
	<div style="float: left;width: 400px;height: 330px;">
		<img src="smartGas.png" width="150" height="150" style="margin-top: 150px; margin-left: 90px">
	</div>
	<div style="width: 70%;float: right; color: black;">
		<h3>Smart Gas</h3>
		<p>
...
<button name="smartgas" style="margin-left: 400px; width: 150px;height: 30px;color: green;background: black; font-size: 20px;"><strong>Check out!</strong></button>
	</div>
	<div style="float: left;width: 400px;height: 230px;">
		<img src="smartMeter.png" width="150" height="150" style="margin-top: 180px; margin-left: 90px">
	</div>
	<div style="width: 70%;float: right; color: black;">
...
<button name="smartmeter" style="margin-left: 400px; width: 150px;height: 30px;color: green;background: black; font-size: 20px;"><strong>Check out!</strong></button>
	</div>
	<div style="float: left;width: 400px;height: 250px;">
		<img src="smartParking.jpg" width="150" height="150" style="margin-top: 280px; margin-left: 90px">
	</div>
	<div style="width: 70%;float: right;; color: black;">
		...
		<button name="smartparking" style="margin-left: 400px; width: 150px;height: 30px;color: green;background: black; font-size: 20px;"><strong>Check out!</strong></button>
	</div>
	<br>
	<div style="float: left;width: 400px;height: 250px;">
		<img src="dustbin.jpeg" width="150" height="150" style="margin-top: 350px; margin-left: 90px">
	</div>
	<div style="width: 70%;float: right;; color: black;">
		<h3>Smart Trash</h3>
		...
		<button name="smarttrash" style="margin-left: 400px; width: 150px;height: 30px;color: green;background: black; font-size: 20px;"><strong>Check out!</strong></button>
	</div>
	<br>
	<div style="float: left;width: 400px;height: 250px;">
		<img src="wifi.jpeg" width="150" height="150" style="margin-top: 450px; margin-left: 90px">
	</div>
	<div style="width: 70%;float: right;; color: black;">
		<h3>Public Wifi</h3>
		...
		<button name="publicwifi" style="margin-left: 400px; width: 150px;height: 30px;color: green;background: black; font-size: 20px;"><strong>Check out!</strong></button>
	</div>
	<br>
	<div style="float: left;width: 400px;height: 250px;">
		<img src="st.jpg" width="150" height="150" style="margin-top: 420px; margin-left: 90px">
	</div>
	<div style="width: 70%;float: right;; color: black;">
		...
		<button name="smarttransportation" style="margin-left: 400px; width: 150px;height: 30px;color: green;background: black; font-size: 20px;"><strong>Check out!</strong></button>
	</div>
	<br>
	<div style="float: left;width: 400px;height: 250px;">
		<img src="ss.jpg" width="150" height="150" style="margin-top: 420px; margin-left: 90px">
	</div>
	<div style="width: 70%;float: right;; color: black;">
		...
		<button name="smartsecurity" style="margin-left: 400px; width: 150px;height: 30px;color: green;background: black; font-size: 20px;"><strong>Check out!</strong></button>
	</div>
	<div style="float: left;width: 400px;height: 250px;">
		<img src="sc.jpg" width="230" height="150" style="margin-top: 400px; margin-left: 50px">
	</div>
	<br>
	<div style="width: 70%;float: right;; color: black;">
		...
		<button name="smartcomm" style="margin-left: 400px; width: 150px;height: 30px;color: green;background: black; font-size: 20px;"><strong>Check out!</strong></button>
	</div>


	<div style="width: 70%;float: right; color: black;">
		<p>Please click on the button below to view the 5 <strong>previously</strong> visited products</p>
		<button name="click1" style="margin-left: 400px; width: 150px;height: 30px;color: green;background: black; font-size: 20px;"><strong>Last Visited</strong></button>
		<p>Please click on the button below to view the 5 <strong>most</strong> visited products</p>
		<button name="click2" style="margin-left: 400px; width: 150px;height: 30px;color: green;background: black; font-size: 20px;"><strong>Most Visited</strong></button>
	</div>
</form>	
</body>